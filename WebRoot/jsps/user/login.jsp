...
body {
	...
	background: #ddd url(jsps/image/login.jpg) repeat top left;
	font-weight: 300;
	font-size: 15px;
	color: #333;
...
<body>
	...
	<form class="form-4" target=""
		...
		<h1>用户登录</h1>
		<div align="center" color="red">${msg }</div>
		<p>
			<input type="text"
				name="userName" placeholder="Username" required/>
			<label id="userNameError">${errors.userNameError }</label>
		</p>
		...
		<p>
			<input type="text" 
				name="checkNum" id="checkNum" placeholder="VerifyCode" /> 
				<label
				id="checkNumError">${errors.checkNumError }</label>
				<img
				id="vCode" src="<c:url value='/checkNum' />" /> <a

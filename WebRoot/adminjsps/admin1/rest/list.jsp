  ...
  <form action="">
    <table class="zebra" width="100%">
    	...
    	<c:forEach items="${restList }" var="rest">
    		...
    		<td><a href="${pageContext.request.contextPath }/admin1Servlet?method=deleteRest&restId=${rest.restId}">删除</a>
    		    <a href="${pageContext.request.contextPath }/admin1Servlet?method=toEditRestPage&restId=${rest.restId}">修改</a></td>
    	</tr>
    	</c:forEach>
    </table>
    </form>
